...
/*--modified*/#include <boost/property_tree/ptree.hpp>
/*--modified*/#include <boost/property_tree/json_parser.hpp>
/*--modified*/boost::property_tree::ptree pt;
...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".total.access", TOTAL_ACCESS);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".total.hit", TOTAL_HIT);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".total.miss", TOTAL_MISS);

    cout << cache->NAME;
    cout << " LOAD      ACCESS: " << setw(10) << cache->roi_access[cpu][0] << "  HIT: " << setw(10) << cache->roi_hit[cpu][0] << "  MISS: " << setw(10) << cache->roi_miss[cpu][0] << endl;
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".load.access", cache->roi_access[cpu][0]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".load.hit", cache->roi_hit[cpu][0]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".load.miss", cache->roi_miss[cpu][0]);

    cout << cache->NAME;
    cout << " RFO       ACCESS: " << setw(10) << cache->roi_access[cpu][1] << "  HIT: " << setw(10) << cache->roi_hit[cpu][1] << "  MISS: " << setw(10) << cache->roi_miss[cpu][1] << endl;
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".rfo.access", cache->roi_access[cpu][1]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".rfo.hit", cache->roi_hit[cpu][1]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".rfo.miss", cache->roi_miss[cpu][1]);
    ...
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch.access", cache->roi_access[cpu][2]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch.hit", cache->roi_hit[cpu][2]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch.miss", cache->roi_miss[cpu][2]);
    ...
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".wb.access", cache->roi_access[cpu][3]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".wb.hit", cache->roi_hit[cpu][3]);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".wb.miss", cache->roi_miss[cpu][3]);
    ...
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch-state.request", cache->pf_requested);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch-state.issue", cache->pf_issued);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch-state.useful", cache->pf_useful);
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch-state.useless", cache->pf_useless);

    cout << cache->NAME;
    cout << " AVERAGE MISS LATENCY: " << (1.0*(cache->total_miss_latency))/TOTAL_MISS << " cycles" << endl;
    /*--modified*/pt.put("roi-stats.cpu"+std::to_string(cpu)+"."+cache->NAME+".avg-miss-latency", std::to_string((1.0*(cache->total_miss_latency))/TOTAL_MISS)+"cycles");
...
void print_sim_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cout << cache->NAME;
    cout << " TOTAL     ACCESS: " << setw(10) << TOTAL_ACCESS << "  HIT: " << setw(10) << TOTAL_HIT << "  MISS: " << setw(10) << TOTAL_MISS << endl;
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".total.access", TOTAL_ACCESS);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".total.hit", TOTAL_HIT);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".total.miss", TOTAL_MISS);

    cout << cache->NAME;
    cout << " LOAD      ACCESS: " << setw(10) << cache->sim_access[cpu][0] << "  HIT: " << setw(10) << cache->sim_hit[cpu][0] << "  MISS: " << setw(10) << cache->sim_miss[cpu][0] << endl;
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".load.access", cache->sim_access[cpu][0]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".load.hit", cache->sim_hit[cpu][0]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".load.miss", cache->sim_miss[cpu][0]);

    cout << cache->NAME;
    cout << " RFO       ACCESS: " << setw(10) << cache->sim_access[cpu][1] << "  HIT: " << setw(10) << cache->sim_hit[cpu][1] << "  MISS: " << setw(10) << cache->sim_miss[cpu][1] << endl;
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".rfo.access", cache->sim_access[cpu][1]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".rfo.hit", cache->sim_hit[cpu][1]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".rfo.miss", cache->sim_miss[cpu][1]);
    ...
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch.access", cache->sim_access[cpu][2]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch.hit", cache->sim_hit[cpu][2]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".prefetch.miss", cache->sim_miss[cpu][2]);
    ...
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".wb.access", cache->sim_access[cpu][3]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".wb.hit", cache->sim_hit[cpu][3]);
    /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(cpu)+"."+cache->NAME+".wb.miss", cache->sim_miss[cpu][3]);
}
...
void print_branch_stats()
{
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        ...
        /*--modified*/pt.put("branch-prediction.cpu"+std::to_string(i)+".accuracy", std::to_string((100.0*(ooo_cpu[i].num_branch - ooo_cpu[i].branch_mispredictions)) / ooo_cpu[i].num_branch)+"%");
        /*--modified*/pt.put("branch-prediction.cpu"+std::to_string(i)+".mpki", (1000.0*ooo_cpu[i].branch_mispredictions)/(ooo_cpu[i].num_retired - ooo_cpu[i].warmup_instructions));
        /*--modified*/pt.put("branch-prediction.cpu"+std::to_string(i)+".avg-rob-occupancy-at-mispredict", (1.0*ooo_cpu[i].total_rob_occupancy_at_branch_mispredict)/ooo_cpu[i].branch_mispredictions);
        ...
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".not-branch", std::to_string(ooo_cpu[i].total_branch_types[0])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[0])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".branch-direct-jump", std::to_string(ooo_cpu[i].total_branch_types[1])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[1])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".branch-indirect", std::to_string(ooo_cpu[i].total_branch_types[2])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[2])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".branch-conditional", std::to_string(ooo_cpu[i].total_branch_types[3])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[3])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".branch-direct-call", std::to_string(ooo_cpu[i].total_branch_types[4])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[4])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".branch-indirect-call", std::to_string(ooo_cpu[i].total_branch_types[5])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[5])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".return", std::to_string(ooo_cpu[i].total_branch_types[6])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[6])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
        /*--modified*/pt.put("branch-type.cpu"+std::to_string(i)+".branch-other", std::to_string(ooo_cpu[i].total_branch_types[7])+"("+std::to_string((100.0*ooo_cpu[i].total_branch_types[7])/(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr))+"%)");
    }
}
...
void print_dram_stats()
{
    ...
    for (uint32_t i=0; i<DRAM_CHANNELS; i++) {
        ...
        /*--modified*/pt.put("dram-stats.channel", i);
        /*--modified*/pt.put("dram-stats.rq.row-buffer-hit", uncore.DRAM.RQ[i].ROW_BUFFER_HIT);
        /*--modified*/pt.put("dram-stats.rq.row-buffer-miss", uncore.DRAM.RQ[i].ROW_BUFFER_MISS);
        /*--modified*/pt.put("dram-stats.dbus-congested", uncore.DRAM.dbus_congested[NUM_TYPES][NUM_TYPES]);
        /*--modified*/pt.put("dram-stats.wq.row-buffer-hit", uncore.DRAM.WQ[i].ROW_BUFFER_HIT);
        /*--modified*/pt.put("dram-stats.wq.row-buffer-miss", uncore.DRAM.WQ[i].ROW_BUFFER_MISS);
        /*--modified*/pt.put("dram-stats.wq.full", uncore.DRAM.WQ[i].FULL);
    }
    ...
    if (uncore.DRAM.dbus_congested[NUM_TYPES][NUM_TYPES]) {
        ...
        /*--modified*/pt.put("dram-stats.avg-congested-cycle", (total_congested_cycle / uncore.DRAM.dbus_congested[NUM_TYPES][NUM_TYPES]));
    }
    else {
        cout << " AVG_CONGESTED_CYCLE: -" << endl;
        /*--modified*/pt.put("dram-stats.avg-congested-cycle", "-");
    }
}
...
int main(int argc, char** argv)
{
    ...
    /*--modified*/pt.put("warmup-instr", warmup_instructions);
    /*--modified*/pt.put("sim-instr", simulation_instructions);
    /*--modified*/pt.put("num-cpu", NUM_CPUS);
    /*--modified*/pt.put("llc-set", LLC_SET);
    /*--modified*/pt.put("llc-way", LLC_WAY);
    ...
    /*--modified*/pt.put("dram.size", std::to_string(DRAM_SIZE)+"MB");
    /*--modified*/pt.put("dram.channel", DRAM_CHANNELS);
    /*--modified*/pt.put("dram.width", std::to_string(8*DRAM_CHANNEL_WIDTH)+"bit");
    /*--modified*/pt.put("dram.rate", std::to_string(DRAM_MTPS)+"MT/s");
	      ...
	      if ((ooo_cpu[i].IFETCH_BUFFER.occupancy < ooo_cpu[i].IFETCH_BUFFER.SIZE) && (ooo_cpu[i].fetch_stall == 0))
		{
		  ooo_cpu[i].read_from_trace();
            ...
            if (show_heartbeat && (ooo_cpu[i].num_retired >= ooo_cpu[i].next_print_instruction)) {
                ...
                cout << " (Simulation time: " << elapsed_hour << " hr " << elapsed_minute << " min " << elapsed_second << " sec) " << endl;
                /*--modified*/pt.put("heartbeat.cpu"+std::to_string(i)+".instr", ooo_cpu[i].num_retired);
                /*--modified*/pt.put("heartbeat.cpu"+std::to_string(i)+".cycle", current_core_cycle[i]);
                /*--modified*/pt.put("heartbeat.cpu"+std::to_string(i)+".ipc", heartbeat_ipc);
                /*--modified*/pt.put("heartbeat.cpu"+std::to_string(i)+".ipc-cumulative", cumulative_ipc);
            ...
            */
            ...
            if ((all_warmup_complete > NUM_CPUS) && (simulation_complete[i] == 0) && (ooo_cpu[i].num_retired >= (ooo_cpu[i].begin_sim_instr + ooo_cpu[i].simulation_instructions))) {
                ...
                cout << " (Simulation time: " << elapsed_hour << " hr " << elapsed_minute << " min " << elapsed_second << " sec) " << endl;
                /*--modified*/pt.put("finished.cpu"+std::to_string(i)+".instr", ooo_cpu[i].finish_sim_instr);
                /*--modified*/pt.put("finished.cpu"+std::to_string(i)+".cycle", ooo_cpu[i].finish_sim_cycle);
                /*--modified*/pt.put("finished.cpu"+std::to_string(i)+".ipc-cumulative", ((float) ooo_cpu[i].finish_sim_instr / ooo_cpu[i].finish_sim_cycle));
    ...
    if (NUM_CPUS > 1) {
        ...
        for (uint32_t i=0; i<NUM_CPUS; i++) {
            ...
            /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(i)+".ipc-cumulative", (float)(ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr) / (current_core_cycle[i] - ooo_cpu[i].begin_sim_cycle));
            /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(i)+".instr", ooo_cpu[i].num_retired - ooo_cpu[i].begin_sim_instr);
            /*--modified*/pt.put("total-sim-static-except-warmup.cpu"+std::to_string(i)+".cycle", current_core_cycle[i] - ooo_cpu[i].begin_sim_cycle);
#ifndef CRC2_COMPILE
    ...
    for (uint32_t i=0; i<NUM_CPUS; i++) {
        ...
        /*--modified*/pt.put("roi-stats.cpu"+std::to_string(i)+".ipc-cumulative", ((float) ooo_cpu[i].finish_sim_instr / ooo_cpu[i].finish_sim_cycle));
        /*--modified*/pt.put("roi-stats.cpu"+std::to_string(i)+".instr", ooo_cpu[i].finish_sim_instr);
        /*--modified*/pt.put("roi-stats.cpu"+std::to_string(i)+".cycle", ooo_cpu[i].finish_sim_cycle);
#ifndef CRC2_COMPILE
