...
mkdir -p $PWD/results_${N_SIM}M
($PWD/bin/${BINARY} -warmup_instructions ${N_WARM}000000 -simulation_instructions ${N_SIM}000000 ${OPTION} -traces ${TRACE_DIR}/${TRACE}) &> $PWD/results_${N_SIM}M/${TRACE}-${BINARY}${OPTION}.txt
